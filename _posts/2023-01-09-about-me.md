...
img: aboutme_logo_white_1024.png # Add image post (optional)
fig-caption: # Add figcaption (optional)
tags: [Holidays, Hawaii]
---
I am currently a Marie Sklodowska-Curie postdoctoral fellow with [Prof. Lucia Melloni](https://www.aesthetics.mpg.de/en/research/research-group-neural-circuits-consciousness-and-cognition.html) at the Max Planck Institute of Empirical Aesthetics in Frankfurt/Main (Germany) and [Prof. Viola Priesemann](https://www.viola-priesemann.de/) at the Max Planck Institute for Dynamics and Self-Organization in G&#246;ttingen (Germany). 
